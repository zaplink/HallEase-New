...
const HomePage = () => {
	return (
		<div className='min-h-screen bg-gray-50 flex flex-col'>
			<nav className='bg-gradient-to-r from-gray-500 to-white shadow-lg fixed top-0 right-0 w-full z-10'>
					...
					<Card className='bg-white/75 max-w-3xl mx-auto p-8 rounded-lg shadow-lg border border-gray-200'>
						...
						<CardContent>
							<p className='text-lg text-gray-700 leading-relaxed'>
								...
								our inception on 2016 , we've been pioneers of
								technological advancement in Sri Lanka,
